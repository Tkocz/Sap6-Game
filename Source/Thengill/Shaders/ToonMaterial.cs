...
///          model. This material is "toon mapped"!</summary>
public class ToonMaterial: MaterialShader {
    //--------------------------------------
    // NON-PUBLIC FIELDS
    //--------------------------------------
    ...
    /// <summary>The number of diffuse shade levels.</summary>
    private int mDifLevels;

    /// <summary>The number of specular shade levels.</summary>
    private int mSpeLevels;

    /// <summary>Indicates whether to use vertex colors.</summary>
    private bool mUseVertCol;

    //--------------------------------------
    // PUBLIC CONSTRUCTORS
    //--------------------------------------

    /// <summary>Initializes a new toon material.</summary>
    ...
    public ToonMaterial(Vector3   amb,
                        Vector3   dif,
                        Vector3   spe,
                        float     k,
                        ...
                        int       difLevels  = 3,
                        int       speLevels  = 3,
                        bool      useVertCol = false)
        : base(Game1.Inst.Content.Load<Effect>("Effects/ToonMaterial"))
    {
        mAmb        = amb;
        mDif        = dif;
        mSpe        = spe;
        ...
        mDifLevels  = difLevels;
        mSpeLevels  = speLevels;
        mUseVertCol = useVertCol;
    }
    ...
    public override void Prerender() {
        ...
        mEffect.Parameters["DifLevels" ].SetValue(mDifLevels);
        mEffect.Parameters["SpeLevels" ].SetValue(mSpeLevels);
        mEffect.Parameters["UseVertCol"].SetValue(mUseVertCol);
